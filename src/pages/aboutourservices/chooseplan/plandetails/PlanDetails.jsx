...
const PlanDetails = () => {
  ...
  const setDataHandler = (data) => {    
    setActiveData("");
    setTimeout(() => {setActiveData(data)}, 500);
  }
    ...
    <div className="choose_plan_grid">
            ...
            return (
              ...
              >
                <span className="round">
                  ...
                  <div className={`inner_disc ${activeData.id === data.id ? "active" : ""}`}>
      ...
      <div className="plan_content_wrap">
        ...
        <div className="price_line">
            <h3>${activeData.price}<span>/Month</span></h3>
        ...
        <div className="btn_line">
            <button type="button" className="secondarybtn">start free trial</button>
            <button type="button" className="primarybtn">select plan</button>
        </div>
      </div>
      }
    </div>
