...
const LanguageDd = () => {
  ...
  const [lang, setLang] = useState(domainName() === "net" ? "en" : "en");
  ...
  useEffect(() => {
    ...
    if (language) {
      ...
      localStorage.setItem("lang", domainName() === "net" ? "en" : "en");

      setLang(domainName() === "net" ? "en" : "en");
      i18n.changeLanguage(domainName() === "net" ? "en" : "en");
      dispatch({
        type: languageChanges(),
        payload: domainName() === "net" ? "en" : "en",
      });
    }
  }, []);
